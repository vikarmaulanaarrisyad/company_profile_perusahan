        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('phone_hours') is-invalid @enderror"
                        name="phone_hours" id="phone_hours" value="{{ old('phone_hours') ?? $setting->phone_hours }}">
                    @error('phone_hours')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('city') is-invalid @enderror" name="city"
                        id="city" value="{{ old('city') ?? $setting->city }}">
                    @error('city')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
